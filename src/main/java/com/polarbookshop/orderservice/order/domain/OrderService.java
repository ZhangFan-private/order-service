...
import com.polarbookshop.orderservice.order.event.OrderAccpetedMessage;
...
public class OrderService {
    ...
    private void publishOrderAcceptedEvent(Order order) {
        ...
        log.info("Sending order accepted event for order {}", order.id());
        var result = streamBridge.send("acceptOrder-out-0", new OrderAccpetedMessage(order.id()));
